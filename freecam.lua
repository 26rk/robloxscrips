...
local Input = {} do
    ...
    ContextActionService:BindActionAtPriority("FreecamKeyboard", function(_, state, input)
        keyboard[input.KeyCode.Name] = state == Enum.UserInputState.Begin and 1 or 0
        return Enum.ContextActionResult.Sink
    end, false, 2000, Enum.KeyCode.W, Enum.KeyCode.A, Enum.KeyCode.S, Enum.KeyCode.D, Enum.KeyCode.E, Enum.KeyCode.Q, Enum.KeyCode.U, Enum.KeyCode.H, Enum.KeyCode.J, Enum.KeyCode.K, Enum.KeyCode.I, Enum.KeyCode.Y, Enum.KeyCode.Up, Enum.KeyCode.Down)

    ContextActionService:BindActionAtPriority("FreecamMousePan", function(_, _, input)
        local delta = input.Delta
        mouse.Delta = Vector2.new(-delta.y, -delta.x)
        return Enum.ContextActionResult.Sink
    end, false, 2000, Enum.UserInputType.MouseMovement)

    ContextActionService:BindActionAtPriority("FreecamMouseWheel", function(_, _, input)
        mouse.MouseWheel = -input.Position.z
        return Enum.ContextActionResult.Sink
    end, false, 2000, Enum.UserInputType.MouseWheel)
end
...
ContextActionService:BindActionAtPriority("FreecamToggle", function(_, state)
    if state == Enum.UserInputState.Begin then
        ToggleFreecam()
    end
    return Enum.ContextActionResult.Pass
end, false, 1000, FREECAM_TOGGLE)

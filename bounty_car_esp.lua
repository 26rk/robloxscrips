...
VisualsTab:Colorpicker({ Title = "Label Color", Desc = "Color of the vehicle name / info text.", Default = NameColor, Callback = function(c) NameColor = c for _, obj in pairs(ESPObjects) do obj.label.Color = NameColor end end })
VisualsTab:Colorpicker({ Title = "Box Color", Desc = "Color of the bounding box drawn around vehicles.", Default = BoxColor, Callback = function(c) BoxColor = c for _, obj in pairs(ESPObjects) do obj.box.Color = BoxColor end end })
VisualsTab:Colorpicker({ Title = "Tracer Color", Desc = "Color of the tracer lines.", Default = TracerColor, Callback = function(c) TracerColor = c for _, obj in pairs(ESPObjects) do obj.tracer.Color = TracerColor end end })
...
VisualsTab:Slider({ Title = "Label Font Size", Desc = "Size of the text labels drawn on screen.", Value = { Min = 10, Max = 24, Default = 24 }, Step = 1, Callback = function(v) LabelFontSize = tonumber(v) or 24 for _, obj in pairs(ESPObjects) do obj.label.Size = LabelFontSize end end })
